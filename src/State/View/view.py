...
class View:
    def __init__(self, root, controller):
        ...
        self.root.title("Top 10 melhores paints da atualidade")
    ...
    def interface(self):
        ...
        seletor = OptionMenu(toolbar, self.tipo_figura_var, "Rabisco", "Rabisco", "Linha", "Retangulo", "Oval",
                             "Circulo", "Poligono", "Poligono Regular", "Selecionar")
        ...
        btn_salvar = Button(toolbar, text="Salvar", command=self.controller.salvar_arquivo)
        btn_salvar.pack(side=LEFT, padx=5)

        btn_abrir = Button(toolbar, text="Abrir", command=self.controller.abrir_arquivo)
    ...
    def configurar_eventos(self):
        ...
        self.canvas.bind("<Button-3>", self.controller.ao_clique_direito)